...
class Lib_login
{
    ...
    public function facebook()
    {
        ...
        $facebook_default_logoutUrl = explode(',', $this->ci->config->item("facebook_logout_redirect_url"));
        ...
        $helper = new FacebookRedirectLoginHelper(site_url($facebook_default_logoutUrl));
        ...
        if (isset($session)) {
            ...
            $fb_data = array(
            	...
            	'logOutUrl' => $helper->getLogoutUrl($session, $facebook_default_logoutUrl),
