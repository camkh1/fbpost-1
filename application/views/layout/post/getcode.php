                    ...
                    <div class="widget-content">
                        <div class="row" style="margin-bottom:10px;">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label class="radio-inline">
                                            <input type="radio" value="tynewplayer" name="codetype" class="required" />
                                            <i class="subtopmenu hangmeas">New Player</i>
                                        </label>
                                    </div>
                                    <div class="col-md-8">
                                        <textarea onclick="this.focus();
                                                    this.select()" class="form-control" name="ytplayerBody" cols="5" rows="3"><?php
                                                  if (!empty($vdolist)):
                                                      $i = 0;
                                                      foreach ($vdolist as $vdo):
                                                          $i++;
                                                          ?><?php if ($i == 1): ?><img border="0" id="noi" src="<?php echo $Thumbnail; ?>" alt="<?php echo $vdotitle; ?>" title="<?php echo $vdotitle; ?>" /><meta property="og:image" content="<?php echo $BigThumbnail; ?>"/><link href="<?php echo $BigThumbnail; ?>" rel="image_src"/><!--more--><script> $(function() { var list = [<?php endif; ?>{"file": "http://www.youtube.com/watch?v=<?php echo $vdo->{Tbl_meta::value}; ?>", "title": "Part <?php echo $vdo->{Tbl_meta::key}; ?>: <?php echo $vdotitle; ?>", "description": "<?php echo $vdotitle; ?>", "image": ""},<?php endforeach; ?>]; khmervideo_media_list._selectedPlayAllVideo(list); });</script><?php foreach ($vdolist as $vdo): ?><div align="center"><div style="font-size: 16px;font-weight: bold; padding:10px; clear:both; width:90%;overflow:hidden;margin-bottom:2px; text-align:center;border:1px solid #555;"><a href="/p/player.html?http://youtu.be/<?php echo $vdo->{Tbl_meta::value}; ?>" target="_blank"><?php echo $vdotitle; ?> Part - <?php echo $vdo->{Tbl_meta::key}; ?></a></div></div><?php
                                                endforeach;
                                            endif;
                                            ?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4">Limon Title</label>
                                    <div class="col-md-8">
                                        <input type="text" value="<?php //echo $vdotitle; ?>" name="limontitle" class="form-control" />
                                    </div>
                                </div>
