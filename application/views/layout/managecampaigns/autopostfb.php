...
<div class="row">
 ...
 if($this->input->get('action') =='posttoblog'):
    ...
    <?php exit(); else:?>
        <script language="javascript" type="text/javascript">window.setTimeout( function(){window.location = "<?php echo base_url();?>managecampaigns/autopostfb?action=yt&post_only=1";},1000*60*40);</script>
    <?php exit(); endif;?>
<?php endif;?>
