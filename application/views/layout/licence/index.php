        ...
        echo $title;
				...
				<div class="toolbar no-padding">
					<div class="btn-group">
						...
						<a href="<?php echo base_url();?>licence/add"><span class="btn btn-xs btn-warning"> <i class="icon-plus"></i> Add</span></a>
						</span>
					</div>
				</div>
			</div>
...
?>
        ...
        echo $value->l_id; ?>" /></td>
								...
								<td><b><?php echo $value->l_name; ?></b><br/><?php echo $value->l_tel;?></td>
								<td><?php echo $value->l_money_id; ?> - <?php echo $value->l_transfer_by; ?><br/><?php echo date('d-m-Y',$value->l_start_date); ?></td>
								<td class="hidden-xs"><?php echo date('d-m-Y',$value->l_start_date); ?></td>
								<td class="hidden-xs"><?php echo date('d-m-Y',$value->l_end_date); ?></td>
                                <td>$<?php echo $value->l_price;?></td>
								<td class="hidden-xs"><?php echo $value->l_type; ?></td>
								<td>
								...
								<td style="width: 80px;">
									<div class="btn-group">
										...
										<ul class="dropdown-menu">
											<li><a
												href="<?php
        echo base_url(); ?>licence/approve?id=<?php
        echo $value->l_id; ?>"><i class="icon-pencil"></i> Approve</a></li>
											<li><a
												href="<?php
        echo base_url(); ?>licence/add?id=<?php
        echo $value->l_id; ?>"><i class="icon-pencil"></i> Edit</a></li>
