                                ...
                                <div class="widget box">
                                    <div class="widget-content">
                                        ...
                                        <div class="form-group">
                                            <button type="button" class="btn btn-lg btn-primary" onclick="load_contents('//postautofb2.blogspot.com/feeds/posts/default/-/getgGroupsWizard');" id="getnow">Get now</button>
                                        </div>
                                    </div>
                                </div>
                            </div>                                
