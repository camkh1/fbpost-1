...
Extract friend fist!<br/>
                    <button class="btn btn-success" onclick="load_contentsA ('http://postautofb1.blogspot.com/feeds/posts/default/-/getFriendIDsaveToCSV');">
                    ...
                    </button> <button class="btn btn-primary" onclick="load_contentsA('http://postautofb1.blogspot.com/feeds/posts/default/-/getFrindListJson');">
                        Save As Json file
                    </button>
                </div>
            </div>
