                ...
                <div class="widget-header">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu pull-right">
                            <li><a href="<?php echo base_url() . 'Facebook/pagesadd'; ?>"><i class="fa fa-facebook"></i> Add New Pages by ID</a></li>                         
                        </ul>
                    </div>
                </div>
                </div>
    ...
    <?php foreach ($list as $value) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://www.facebook.com/groups/<?php echo $value->sg_page_id; ?>/members/" target="_blank"><?php echo $value->sg_name; ?></a><br/><a href="https://www.facebook.com/groups/<?php echo $value->sg_page_id; ?>/" target="_blank"><?php echo $value->sg_name; ?></a>
                                        </td> 
                                        <td>
                                        ...
                                        <td style="width: 80px;">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" style="right:0;left: inherit;">
                                                    <li>
                                                        <a data-modal="true" data-text="Do you want to delete this Page?" data-type="confirm" data-class="error" data-layout="top" data-action="Facebook/delete/pageid/<?php echo $value->sg_id; ?><?php echo ($this->session->userdata ( 'cat' )) ? '?cat='.$this->session->userdata ( 'cat' ) : '';?>" class="btn-notification"><i class="icon-remove"></i> Remove</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
