...
;(function($){
	...
	var isPreservedAttribute = function(attribute){
		preserverdAttributes = ["containerClass", "watermarkerClass", "watermarkImageClass", "watermarkerDataId"];
	...
	var getForAttribute = function(attributeName, attributeValue, defaultValue){
		return isPreservedAttribute(attributeName) && (attributeValue !== undefined && attributeValue !== null ) ? attributeValue : defaultValue;
	}
	...
	var getCoords = function(element){
		if(element !== undefined && element !== null){
			var opt = { x:element.offsetLeft,
				...
				id: $(element).find("img").attr("dataid"),
				imagePath: $(element).find("img").attr("src")
			}
	...
	$.watermarker = function(object, userOptions){
		...
		var watermarkImageAttName = getForAttribute("watermarkerDataId",userOptions.watermarkerDataId, options.watermarkerDataId);			
		...
		var watermarkImage = $("<img>", {src: options.imagePath, "class": watermarkImageClassName,"dataid":watermarkImageAttName});
