			   ...
			   <ul class="nav ace-nav pull-right">
					 <li class="grey">
						 ...
						 <ul class="pull-right dropdown-navbar dropdown-menu dropdown-caret dropdown-closer">
							 <li class="nav-header">
								 <i class="icon-ok"></i> 4 Tasks to ________
							 </li>
					 ...
					 <li class="purple">
						 ...
						 <ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-closer">
							 ...
							 <li>
								 <a href="#">
									 <i class="icon-user btn btn-mini btn-primary"></i> Bob just signed __ as an editor ...
								 </a>
							 </li>
								 ...
								 <a href="#">
									 ...
									 <span class="msg-body">
										 <span class="msg-title">
											...
											Ciao sociis natoque penatibus __ auctor ...
										 </span>
										 <span class="msg-time">
								 ...
								 <a href="#">
									 ...
									 <span class="msg-body">
										 <span class="msg-title">
											...
											Vestibulum id ligula porta _____ euismod ...
										 </span>
										 <span class="msg-time">
								 ...
								 <a href="#">
									 ...
									 <span class="msg-body">
										 <span class="msg-title">
											...
											Nullam quis risus eget ____ mollis ornare ...
										 </span>
										 <span class="msg-time">
