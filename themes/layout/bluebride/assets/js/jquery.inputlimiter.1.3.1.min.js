...
$this.unbind('.inputlimiter');$this.bind('./keyup.inputlimiter.html',inputlimiterKeyup);$this.bind('./keypress.inputlimiter.html',inputlimiterKeypress);$this.bind('./blur.inputlimiter.html',inputlimiterBlur);}});};$.fn.inputlimiter.remtextfilter=function(opts,charsRemaining){var remText=opts.remText;if(charsRemaining===0&&opts.remFullText!==null){remText=opts.remFullText;}
